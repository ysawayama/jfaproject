...
export default function EditEventPage() {
  ...
  useEffect(() => {
    if (event) {
      setFormData({
        ...
        attendanceDeadline: event.attendanceDeadline.replace('Z', ''),
      });
      setBringItems(event.bringItems || []);
    }
  }, [event]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert('イベントを更新しました！');
    router.push(`/team/long-term/schedule/${eventId}`);
  };
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-2">
                {(
                  ['practice', 'match', 'tournament', 'event', 'meeting'] as EventType[]
                ).map((type) => {

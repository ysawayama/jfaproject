    ...
    return (
      <div className="flex items-center justify-center min-h-[50vh]">
        <div className="text-center">
          ...
          <Link
            href="/team/long-term/communication"
        ...
        <form onSubmit={handleSendMessage} className="flex items-end gap-3">
          ...
          <div className="flex-1">
            <textarea
              ...
              rows={1}
              className="w-full px-4 py-3 border border-neutral-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500/50 resize-none"
              onKeyDown={(e) => {
